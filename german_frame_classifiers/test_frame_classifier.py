...
# Load test data
test_labels = torch.load("./test_data/"+test_name+"_label_tensors_class_72_len_67.pt")
test_data = torch.load("./test_data/"+test_name+"_text_tensors_class_72_len_67.pt")
test_att = torch.load("./test_data/"+test_name+"_attention_tensors_class_72_len_67.pt") 
test_pos = torch.load("./test_data/"+test_name+"_position_tensors_class_72_len_67.pt")
test_beta = torch.load("./test_data/"+test_name+"_beta_tensors_class_72_len_67.pt")
...
class BertFrameClassifier(torch.nn.Module):
  def __init__(self, num_labels, dropout=0.1):
    ...
    self.model = AutoModel.from_pretrained('bert-base-german-dbmdz-cased', output_hidden_states=False, output_attentions=False)
...
checkpoint = torch.load("./models/w10_hl12_sampled_checkpoint.pt", map_location="cuda:3")
...
with open("./w10_hl12_sampled_"+test_name+"_wrong_predictions.txt", "w") as f:
