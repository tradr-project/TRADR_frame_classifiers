...
test_name = sys.argv[1] # should be of form 'tradr_test_c' or 'framenet_test', etc.

# Read in all the data
df = pd.read_csv("./data/framenet_main.tsv", delimiter='\t', header=0, names=['sentence_text', 'target_indices', 'lu', 'frame'], quoting=3)
...
# Load test data
test_labels = torch.load("./test_data/framenet/"+test_name+"_label_tensors_class_931_len_314.pt")
test_data = torch.load("./test_data/framenet/"+test_name+"_text_tensors_class_931_len_314.pt")
test_att = torch.load("./test_data/framenet/"+test_name+"_attention_tensors_class_931_len_314.pt") 
test_pos = torch.load("./test_data/framenet/"+test_name+"_position_tensors_class_931_len_314.pt")
test_beta = torch.load("./test_data/framenet/"+test_name+"_beta_tensors_class_931_len_314.pt")
...
checkpoint = torch.load("./models/frame_classifier_fn.pt", map_location="cuda:3")
...
with open("./frame_classifier_fn_"+test_name+"_wrong_predictions.txt", "w") as f:
